...
public class UpdateAppointment implements Initializable {
    ...
    public ComboBox  <String> strHoursCombo;
    public ComboBox <String> strMinCombo;
    ...
    private Appointment updateApp= MainMenu.passToAUpdate();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        locationTextField.setText(updateApp.getLocation());
        titleTextField.setText(updateApp.getTitle());
        typeTextField.setText(updateApp.getType());
        idTextField.setText(String.valueOf(updateApp.getAppointment_id()));
        descriptionTextField.setText(updateApp.getDescription());
        locationTextField.setText(locationTextField.getText());
        userComboBox.setValue(String.valueOf(updateApp.getUser_id()));
        customerComboBox.setValue(String.valueOf(updateApp.getCustomer_id()));
        contactComboBox.setValue(updateApp.getContact_name());
        strHoursCombo.setValue(String.valueOf(updateApp.getStart().getHour()));
        strMinCombo.setValue(String.valueOf(updateApp.getStart().getMinute()));
        endMinCombo.setValue(String.valueOf(updateApp.getEnd().getMinute()));
        endHourCombo.setValue(String.valueOf(updateApp.getEnd().getHour()));
        strDatePicker.setValue(updateApp.getStart().toLocalDate());
        endDatePicker.setValue(updateApp.getEnd().toLocalDate());
    ...
    public void saveHandler(ActionEvent actionEvent) throws IOException{
        ...
        if(title == null || user == null || customer == null || contact  < 1 || start == null || end ==null){
            ...
            AppointmentDAO.updateAppointment(id, title, description, location, type, start,
    ...
    public String startTimeFormatter(){
        ...
        String hour = strHoursCombo.getValue();
        String minute = strMinCombo.getValue();
    ...
    public String endTimeFormatter(){
        ...
        String hour = endHourCombo.getValue();
        String minute = endMinCombo.getValue();
        if(date == null || hour == null || minute == null ){
            return null;
        }else {
